    ...
    stages {
        stage('Build') {
            ...
            steps {
                ...
                String path2 = "C:/Windows/system32/config/systemprofile/AppData/Local/Jenkins/.jenkins/workspace/FidexioCredentialDemo_master/src/test/java/com/Pages/PageBase.java"
