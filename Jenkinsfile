    ...
    stages {
        stage('Build') {
            ...
            steps {
                ...
                bat "powershell (get-content C:\\Windows\\system32\\config\\systemprofile\\AppData\\Local\\Jenkins\\.jenkins\\workspace\\EbayLogin_master\\src\\test\\java\\com\\Pages\\PageBase.java) -replace 'ahmet','${SECRET_TEXT_ID}'"
